...
#define _DUTY_MIN 420  // servo full clock-wise position (0 degree)
#define _DUTY_NEU 1465  // servo neutral position (90 degree)
#define _DUTY_MAX 2510  // servo full counter-clockwise position (180 degree)
